...
struct AuxiliarySummer {
  ...
  AuxiliarySummer(Renderer &_renderer)
      : renderer(_renderer),
   helperVertical(renderer),
   helperHorizontal(renderer)
 {}
...
struct IntegralImageHelper {
  ...
  static ImageStorage BuildImageStorage(vk::Device dev, vk::CommandPool commandPool, vk::PhysicalDeviceMemoryProperties memprop, vk::Queue queue,
  ...
  void draw(
    ...
    
    {
      ...
      shaderList.helperIntegralPass2(
          v2::WorkgroupFromDomainGrid<Shaders::GuidedFilterPass2>(width, height), commandBuffer,
                          *renderer.descriptorSetPool, tex, storedImage.auxiliaryImage.columnReducedMatrixSummed,
                          storedImage.auxiliaryImage.squaredColumnReducedMatrixSummed, storedImage.auxiliaryImage.rowReducedMatrixSummed2,
                          storedImage.auxiliaryImage.squaredRowReducedMatrixSummed2, storedImage.teximageIntegral,
                          storedImage.texsquaredImageIntegral);
    }

      shaderList.helperAveraging(v2::WorkgroupFromDomainGrid<Shaders::AveragingShader>(width, height), commandBuffer,
                      *renderer.descriptorSetPool,
                      storedImage.teximageIntegral, storedImage.texsquaredImageIntegral, storedImage.meanI, storedImage.meanSqI);

    {
      ...
      shaderList.helperMeanAAndBPass1(v2::WorkgroupFromDomainGrid<Shaders::MeanAAndBPass1>(width, height), commandBuffer,
                                     *renderer.descriptorSetPool,
                           storedImage.meanI, storedImage.meanSqI, storedImage.auxiliaryImage.columnReducedMatrix,
                           storedImage.auxiliaryImage.squaredColumnReducedMatrix, storedImage.auxiliaryImage.rowReducedMatrix,
                           storedImage.auxiliaryImage.squaredRowReducedMatrix);
      ...
      shaderList.helperMeanAAndBPass2(
          v2::WorkgroupFromDomainGrid<Shaders::MeanAAndBPass2>(width, height), commandBuffer,
                           *renderer.descriptorSetPool, storedImage.meanI, storedImage.meanSqI, storedImage.auxiliaryImage.columnReducedMatrixSummed,
                          storedImage.auxiliaryImage.squaredColumnReducedMatrixSummed, storedImage.auxiliaryImage.rowReducedMatrixSummed2,
      ...
      shaderList.helperFinalPass(v2::WorkgroupFromDomainGrid<Shaders::GuidedFilterFinalPass>(width, height), commandBuffer,
                      *renderer.descriptorSetPool, tex,
                      storedImage.meanA, storedImage.meanB, storedImage.result);
