...
void main() {
  ...
  for (; _47 < _25.x; _46 = _44, _47 = _45) {
    float _35 = imageLoad(_input, ivec2(uvec2(_16, _47 + gl_SubgroupInvocationID))).x;
    imageStore(_output, ivec2(uvec2(_16, _47 + gl_SubgroupInvocationID)), vec4(_46 + subgroupInclusiveAdd(_35)));
