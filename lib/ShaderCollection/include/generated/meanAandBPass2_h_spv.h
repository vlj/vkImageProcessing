struct meanAandBPass2_h_spv 
{
  ...
  meanAandBPass2_h_spv (vk::Device d) : dev(d)
  {
      ...
      Base::NameObject(dev, *pipeline, "meanAandBPass2_h_spv");  }

    std::vector<vk::DescriptorSet> CreateDescriptorSets(
        vk::DescriptorPool descriptorSetPool,
      vk::ImageView I,
      vk::ImageView squaredI,
      vk::ImageView AcolumnReducedMatrix,
      vk::ImageView BColumnReducedMatrix,
      vk::ImageView AReducedMatrix,
      vk::ImageView BRowReducedMatrix,
      vk::ImageView Amean,
      vk::ImageView Bmean
    )
    {
        ...
        {
          auto descriptorImageInfo = vk::DescriptorImageInfo()
            .setImageView(AcolumnReducedMatrix)
            .setImageLayout(vk::ImageLayout::eGeneral);
          descriptorImageInfos.push_back(descriptorImageInfo);
        }
        ...
        {
          auto descriptorImageInfo = vk::DescriptorImageInfo()
            .setImageView(BColumnReducedMatrix)
            .setImageLayout(vk::ImageLayout::eGeneral);
          descriptorImageInfos.push_back(descriptorImageInfo);
        }
        ...
        {
          auto descriptorImageInfo = vk::DescriptorImageInfo()
            .setImageView(BRowReducedMatrix)
            .setImageLayout(vk::ImageLayout::eGeneral);
          descriptorImageInfos.push_back(descriptorImageInfo);
        }
  ...
  )
{
    ...
    auto descriptorSets = CreateDescriptorSets(descriptorSetPool, *I.tex->view,*squaredI.tex->view,*AcolumnReducedMatrix.tex->view,*BColumnReducedMatrix.tex->view,*AReducedMatrix.tex->view,*BRowReducedMatrix.tex->view,*Amean.tex->view,*Bmean.tex->view);
