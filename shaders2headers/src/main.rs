...
mod SPV {
    ...
    fn get_execution_model(execution_model : raw::SpvExecutionModel_) -> ExecutionModel
    {
        match execution_model {
            ...
            raw::SpvExecutionModel__SpvExecutionModelTessellationControl => ExecutionModel::TessellationControl,
            raw::SpvExecutionModel__SpvExecutionModelTessellationEvaluation => ExecutionModel::TessellationEvaluation,
            ...
            raw::SpvExecutionModel__SpvExecutionModelRayGenerationKHR => ExecutionModel::RayGenerationKHR,
...
//            SpvExecutionModel__SpvExecutionModelClosestHitNV => ExecutionModel::ClosestHitNV,
 ...
 //           SpvExecutionModel__SpvExecutionModelCallableNV => ExecutionModel::CallableNV,
    ...
    fn Convert(input:&raw::SpvReflectDescriptorBinding) -> SpvReflectDescriptorBinding {
        ...
        let name = unsafe { std::ffi::CStr::from_ptr(input.name).to_str().unwrap().to_string() };
        let tmp = input.descriptor_type;
        let descriptor_type = match tmp {
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_SAMPLER => DescriptorType::SAMPLER,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER => DescriptorType::COMBINED_IMAGE_SAMPLER,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_SAMPLED_IMAGE => DescriptorType::SAMPLED_IMAGE,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_IMAGE => DescriptorType::STORAGE_IMAGE,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER => DescriptorType::UNIFORM_TEXEL_BUFFER,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER => DescriptorType::STORAGE_TEXEL_BUFFER,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_BUFFER => DescriptorType::UNIFORM_BUFFER,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_BUFFER => DescriptorType::STORAGE_BUFFER,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC => DescriptorType::UNIFORM_BUFFER_DYNAMIC,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC => DescriptorType::STORAGE_BUFFER_DYNAMIC,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_INPUT_ATTACHMENT => DescriptorType::INPUT_ATTACHMENT,
            raw::SpvReflectDescriptorType_SPV_REFLECT_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR => DescriptorType::ACCELERATION_STRUCTURE_KHR,
            _ => panic!("unknow value")
        };
    ...
    pub fn HigherLevelSpvReflectShaderModule(module: raw::SpvReflectShaderModule) -> CleanSpvReflectShaderModule
    {
        let entry_point_name = unsafe {std::ffi::CStr::from_ptr(module.entry_point_name).to_str().unwrap().to_string() };
        ...
        let result = CleanSpvReflectShaderModule{
            ...
            shader_stage: ShaderStageBits{bits: module.shader_stage},
            ...
            push_constant_blocks: toVec(module.push_constant_blocks, module.push_constant_block_count as isize),
            interface_variables: toVec(module.interface_variables, module.interface_variable_count as isize),
            input_variables: toVec(module.input_variables, module.input_variable_count as isize),
            output_variables: toVec(module.output_variables, module.output_variable_count as isize),
...
fn main() -> io::Result<()> {
    ...
    let module = unsafe {
        ...
        let result = SPV::raw::spvReflectCreateShaderModule(buf.len() as u64, buf.as_mut_ptr() as *const std::ffi::c_void, module.as_mut_ptr());
        if result != 0 { return Err(io::Error::from(io::ErrorKind::InvalidData))};
        module.assume_init()
    };

    let properModule = SPV::HigherLevelSpvReflectShaderModule(module);
